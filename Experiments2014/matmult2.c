...
#define PROGRAM_FILE_fp64 "./matmult_partitioning_fp64.kernel"
...
int main_fp()
{
    ...
    printf("Controll passed to main_fp\n");
    int i;
    cl_int status;  
...
int main_fp64()
{
    ...
    program = build_program(context, device, PROGRAM_FILE_fp64, defstr,  lendefstr);
